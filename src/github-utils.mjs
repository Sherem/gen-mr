// github-utils.mjs
// GitHub API utilities for pull request operations encapsulated in a factory

/**
 * Create GitHub utils bound to provided configuration.
 * @param {object} cfg
 ...
 * }}
 */
export const createGithubUtils = ({ githubToken }) => {
    if (!githubToken) {
